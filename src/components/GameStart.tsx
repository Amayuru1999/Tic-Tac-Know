...
interface GameStartProps {
  show: boolean;
  handleStartClick: (whoseTurn: string) => void;
}

const GameStart: React.FC<GameStartProps> = ({ show, handleStartClick }) => {
  const [isExiting, setIsExiting] = useState(false);
  const [rndIndex, setRndIndex] = useState<number | null>(null);
